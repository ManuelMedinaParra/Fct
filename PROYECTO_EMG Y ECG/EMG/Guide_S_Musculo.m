...
delete(instrfind({'port'},{'COM12'})); %borrar cualquier puerto serial abierto
puerto=serial('COM12'); %declaro variable llamada puerto y se crea el com4
...
%MVC Testtttttttt
 ...
 %ESCRIBIMOS EN EL TXT DE EMG_RMS
    ...
    fclose(texto);
    plot (handles.Graf3,Tiempo, rms2);
    i=1;
    MCV2(i)=mean(rms2)
