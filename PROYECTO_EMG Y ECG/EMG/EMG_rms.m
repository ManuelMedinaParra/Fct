...
function out = EMG_rms (data, numPoints)

%Funcion que calcula la señal RMS de una EMG

%data-> vector de entrada. Señal de EMG unicamente
%numPoints-> nos marca el tamaño de la ventana de integración. Se puede dejar en blanco si se quiere y por defecto es 51
